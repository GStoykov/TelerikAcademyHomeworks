...
// Define class Circle and suitable constructor so that at initialization height must be
...
class Program
{
    static void Main()
    {
        ...
        {
            Console.WriteLine("The {0} has area {1:0.00}.", figure.GetType(), figure.CalculateSurface());
        }
